...
///
/// `null` on every arm today, and that is a truthful answer rather than a
/// placeholder: no arm ships a store implementation yet, so no build may render
/// a store purchase affordance.
